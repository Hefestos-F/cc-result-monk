...
// @updateURL    https://raw.githubusercontent.com/Hefestos-F/cc-result-monk/main/EmTeste/LoginZendeskTimer.user.js
// @downloadURL  https://raw.githubusercontent.com/Hefestos-F/cc-result-monk/main/EmTeste/LoginZendeskTimer.user.js
// @grant        GM_openInTab
...
(function () {
  ...
  observarItem(() => {
    ...
    const duracaoPrevistaPorStatus = (s) => {
      ...
      //if (s.includes("Descanso")) return "00:00:30";
      return null;
    };
  ...
  function oLoop() {
    ...
    const Estlogado = document.querySelector('[aria-label="Principal"]');
    ...
    if (config.pausalimitada && config.notiEstouro) {
      ...
      if (!stt.bipando && stt.Estouro && config.SomEstouro && Estlogado) {
        stt.bipando = 1;
