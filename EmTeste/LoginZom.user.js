...
// @updateURL    https://raw.githubusercontent.com/Hefestos-F/cc-result-monk/main/EmTeste/LoginZom.user.js
// @downloadURL  https://raw.githubusercontent.com/Hefestos-F/cc-result-monk/main/EmTeste/LoginZom.user.js
// @grant        GM_openInTab
  ...
  observarItem(() => {
    ...
    (async () => {
      ...
      if (duracaoPrevista) {
        ...
        TempoPausas.Estouro = exibirHora(fimPrevistoObj, 0, "00:00:10");
      }
